            ...
            <div style={{ background: "#FFFF", padding: "30px" }}>
                ...
                <div className="row">
                    <div className="col">
                        <Card
                            bordered={true}
                            style={{ background: "#fffff", borderRadius:"15px", color: "#ff7400" }}
                        ...
                        >
                            {this.state.showTableInput &&
                                <div>
                                    ...
                                    <Button
                                        id="matrix_button"
                                        style={{ background: "#ff7400", color: "#ffffff", fontSize: "20px" }}
                            ...
                            {this.state.showInputForm &&
                                <div>
                                    ...
                                    style={{background: "#ff7400", color: "#ffffff" }}>
                                        Submit<br></br>
                                    </Button>
                                </div>
                            }
                    ...
                    <div className="col">
                        {this.state.showOutputCard &&
                            <Card
                                title={"Output"}
                                bordered={true}
                                style={{ background: "#ff7400", color: "#fffff", float: "inline-start" }}
                                id="outputCard"
                            >
