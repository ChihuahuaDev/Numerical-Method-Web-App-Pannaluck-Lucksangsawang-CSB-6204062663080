                ...
                <div className="row">
                        ...
                        >
                            {this.state.showInputForm && 
                                <div>
                                    ...
                                    <Button id="dimention_button" onClick= {
                                        ...
                                        style={{background: "#ff7400", color: "white" }}>
                                        Submit
                                    </Button>
                                </div> 
                            }
                            {this.state.showTableInput && 
                                <div>
                                    ...
                                    <Button 
                                        id="matrix_button"  
                                        style={{background: "#ff7400", color: "white", fontSize: "20px"}}
                    ...
                    <div className="col">
                        {this.state.showOutputCard &&
                            ...
                            title={"Output"}
                            bordered={true}
                            style={{ border: "2px solid black", background: "rgb(255,140,0) none repeat scroll 0% 0%", color: "white" }}
                            >
