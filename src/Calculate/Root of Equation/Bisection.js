            ...
            <div style={{ background: "#FFFF", padding: "30px" }}>
                ...
                <div className="row">
                    <div className="col">
                        <Card
                            bordered={true}
                            style={{ background: "#ffffff", borderRadius:"15px", color: "#ff7400" }}
                        ...
                        >
                            ...
                            <div className="row">
                                <div className="col-3">
                                    ...
                                    style={{ background: "#ff7400", color: "white" }}>Submit</Button>
                                </div>
                                <div className="col">
                                    <Button id="submit_button_api" onClick={() => this.handleAPI()}
                                    style={{ background: "#ff7400", color: "white" }}>Calculate from data that get from API</Button>
                                </div>
                            </div>
                ...
                <div className="row">
                    {this.state.showOutputCard &&
                        <Card
                            title={"Output"}
                            bordered={true}
                            style={{ width: "100%", background: "#ffffff", color: "#ff7400" }}
                            id="outputCard"
                        >
