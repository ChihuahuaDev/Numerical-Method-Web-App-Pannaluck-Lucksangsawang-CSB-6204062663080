...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header className="header" style={{backgroundColor:"#4992a7" ,height: "90px" }}>
            <div className="headertext">
              <label><h2 style={{color:"#FFFFFF"}}>Numerical Method 040613393</h2></label>
            </div>
          </Header>
          <Layout>
            <Header className="header" style={{ backgroundColor:"#FFFFFF" ,color:"#FFFFFF"}}>
              <Menu theme="light" mode="horizontal" style={{color:"#000000"}} >
          ...
          <Footer style={{ backgroundColor: "#fbd000", minHeight: 400 }}>
            <p style={{ fontSize: "20px", fontWeight: "bold", color: "#000000" }}>
              Developer : Pannaluck Lucksangsawang 6204062663080 CSB<br />

              <p style={{fontSize:"22px", verticalAlign:"text-bottom"}}><RightCircleOutlined  style={{ fontSize: "30px" }} /><a target="_blank" rel="noopener noreferrer" href="http://cs.kmutnb.ac.th/" style={{ color: "#000000", textDecoration: "none" }}>  Numerical Methods (040613393) Taught by Teacher Sas Ratanasanya (SRS)</a></p>
              <p >Department of Computer and Information Science Faculty of Applied Science</p><p >King Mongkut's University of Technology North Bangkok</p>
            </p>
          </Footer>
        </Layout>
      </Router>
